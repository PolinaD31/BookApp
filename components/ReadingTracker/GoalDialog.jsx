...
export default function GoalDialog ({ goalDialogVisible, setGoalDialogVisible, currentWeekStart, weekEnd, user }) {
    ...
    const handleReadingGoalSubmit = () => {
      ...
      const scheduleNotification = async () => {
        ...
        if (today > notificationDate) {
            alert('The date you want to schedule the notification for has already passed. Notification canceled.');
            return;
        }
        ...
        <Dialog.Title>Enter your reading goal for this week</Dialog.Title>
            <Dialog.Content>
                <Text style={{marginBottom: 20}}>
                    By enabling reading goal notifications, you will recieve a notification 1 day before the end of the week reminding you to finish your goal.
                </Text>
                <TextInput
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Text style={{marginRight: 10}} >{remindersEnabled ? 'Turn off reading goal reminders' : 'Turn on reading goal reminders'}</Text>
